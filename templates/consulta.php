...
<section class="template-section" id="tumeta">
    ...
    <div class="container center">
        <h2 class="saqua uptown">¡Queremos que<br>
            <span class="big">logremos tu meta!</span></h2>
        ...
        <div class="fcentered">
            ...
            <p>Te ofrecemos tu consulta médico nutricional
             personalizada, analizando composición corporal con tecnología inbody,
              ...
              para obtener la mejor opción de tratamiento.</p>
            </div>
        </div>
        ...
        <div class="flex ">
            ...
            <div class="col col-txt">
                ...
                <ul>
                    ...
                    <li>
                        <p>Creamos para ti un menú totalmente personalizado con comidas fáciles de preparar y deliciosas. </p>
                    </li>
                    <li>
            ...
            <div class="flex">
                ...
                <div class="col col-txt">
                   <div class="fcentered">
                       ...
                       <ul>
                        <li>
                            <p><b>Primera consulta: </b><br>750 MXN</p>
                        </li>
                        <li>
                            <p><b>Consecutivas:</b><br>700 MXN</p>
                        </li>
                    </ul>
