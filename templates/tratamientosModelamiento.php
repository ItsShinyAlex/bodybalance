...
<section class="template-section" id="modelamiento">
    ...
    <div class="container">
        ...
        <div class="mov-hide">
            <div class="w-box">
                <p>Para este tratamiento utilizamos resultados rápidos y efectivos para reducción de medidas en todo el cuerpo.</p>
...
<section class="template-section des-hid" id="t-modela-mov">
    ...
    <div class="container">
       <div class="center">
                 ...
                 <p>Para este tratamiento utilizamos ondas de choque con resultados rápidos y efectivos para reducción de medidas en todo el cuerpo.<br><br>
        ...
        <div class="col">
         ...
         <div class="col">
            <h2>¿Y en que zonas puede utilizarse?</h2>
               <p>Se puede tratar <strong>zonas con depósitos de grasa</strong> en:</p>
               <ul>
                   <li>cara</li>
                   <li>brazos</li>
                   <li>abdomen</li>
